...
import { X, CheckCircle, Send, Upload, CreditCard, Copy, FileText } from "lucide-react"
import { Button } from "@/components/ui/button"
import { ofertaMatni } from "@/lib/oferta-content"
    ...
    <>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="text-xs md:text-sm">
                          ...
                          <p className="text-gray-400 mt-1 pb-1">
                            Xizmatlardan foydalanish uchun ommaviy oferta shartlari bilan tanishib chiqing va qabul qiling.
                          </p>
                        </div>
                      </div>
                    </div>
      ...
      {isOfferModalOpen && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-[60] p-4">
          <div className="bg-gray-900 rounded-2xl w-full max-w-2xl relative border border-gray-700 shadow-2xl flex flex-col max-h-[90vh]">
            <div className="p-4 border-b border-gray-800 flex justify-between items-center sticky top-0 bg-gray-900 rounded-t-2xl z-10">
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar flex-grow">
              <div className="prose prose-invert max-w-none text-sm md:text-base text-gray-300 whitespace-pre-wrap leading-relaxed">
                {ofertaMatni}
              </div>
            </div>

            <div className="p-4 border-t border-gray-800 bg-gray-900 rounded-b-2xl sticky bottom-0 z-10 flex justify-end">
              <Button
                onClick={() => {
