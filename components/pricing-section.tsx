      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 animate-fade-in-up">
            PROP hisob narxlari <span className="text-gray-400">(etapli)</span>
          </h2>
        ...
        <div className="text-center mt-12 space-y-4">
          ...
          <p className="text-red-400 text-sm max-w-4xl mx-auto">
            ...
            minus qilinsа kontrakt bekor qilinadi va prop hisob bloklandi va bu holатda javobgarlik u yoki bu shaxs
