...
import { Clock, Shield, DollarSign, Target } from "lucide-react"
...
export default function InstantLiteSection() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-purple-900/20 via-blue-900/20 to-gray-900/20 relative">
